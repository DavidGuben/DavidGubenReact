    ...
    render() {
        return (
            <div className="animated fadeIn text-center">
                    ...
                    <div className="intro-header animated bounceIn">
                    ...
                    <div className="intro-content animated bounceIn">
                        <h1><b>What I Do</b></h1>
                        <p>Design & develop custom responsive websites or applications that look great on any device.</p>
                    </div>

                    <div className="service-content animated bounceIn flex-container">     
